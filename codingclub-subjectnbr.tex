...
\begin{titlepage}
	\centering
    \vspace*{0.5 cm}
    \includegraphics[scale = 0.20]{assets/cobra.jpg}\\[1.0 cm]	% University Logo
%    \textsc{\LARGE Coding Club}\\[2.0 cm]	% University Name
	\textsc{\Large Tutoriel Coding Club}\\[0.5 cm]				% Course Code
	\textsc{\large SUBJECT CATEGORY}\\[0.5 cm]				% Course Name
	\rule{\linewidth}{0.2 mm} \\[0.4 cm]
	{ \huge \bfseries SUBJECT NAME}\\
